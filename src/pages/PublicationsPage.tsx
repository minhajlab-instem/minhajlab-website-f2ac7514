  ...
  return <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 animate-fade-in-up">
      ...
      <div className="overflow-x-auto bg-white p-1 rounded-lg shadow-lg">
        <Table>
          ...
          <TableBody>
            {sortedPublications.map((pub, index) => <TableRow key={index} className="hover:bg-slate-50 transition-colors">
                ...
                <TableCell className="py-3">
                  {pub.link && pub.link !== "#" ? <a href={pub.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm text-sky-600 hover:text-sky-800 hover:underline font-medium">
                    ...
                    </a> : <a href={`https://doi.org/${pub.doi}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-sm text-sky-600 hover:text-sky-800 hover:underline font-medium">
                      {pub.doi}
                    </a>}
                </TableCell>
              </TableRow>)}
