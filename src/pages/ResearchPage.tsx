...
const ResearchPage: React.FC = () => {
  ...
  return <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 animate-fade-in-up">
      ...
      <div className="space-y-16 mb-20">
        {researchScales.map((scale, index) => <div key={index} className={`bg-gradient-to-r ${scale.color} rounded-2xl p-8 shadow-lg`}>
            {/* Scale Header */}
            <div className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {scale.media.map((item, mediaIndex) => <div key={mediaIndex} className="bg-white rounded-lg p-4 shadow-md">
                  {item.type === 'image' ? <div className="relative">
            ...
            {scale.publications && scale.publications.length > 0 && <div className="bg-white bg-opacity-70 rounded-lg p-6">
                <h4 className="text-lg font-semibold text-slate-800 mb-4 flex items-center">
                  <LinkIcon className="w-5 h-5 mr-2" />
                  Related Publications
                </h4>
                <div className="space-y-2">
                  {scale.publications.map((pub, pubIndex) => <div key={pubIndex}>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
              {fundingAgencies.map((agency, index) => <div key={index} className={`${agency.color} rounded-lg p-3 text-center hover:shadow-md transition-shadow`}>
                  <img src={agency.image} alt={agency.name} className="w-12 h-12 mx-auto mb-2 rounded-full object-cover" />
